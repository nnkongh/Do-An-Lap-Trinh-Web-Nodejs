  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
      <div className="w-full bg-white rounded-lg shadow-lg md:w-1/3">
        <div className="p-6">
          <h3 className="text-xl font-bold mb-4">Cho mượn sách</h3>
          <form onSubmit={handleRecordBook}>
            <div className="mb-4">
              <label className="block text-gray-900">Email người dùng</label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex justify-end space-x-4">
              ...
              <button type="submit" className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">Mượn</button>
            </div>
          </form>
        </div>
      </div>
