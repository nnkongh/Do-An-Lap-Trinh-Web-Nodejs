...
export const resetPassword = (data, token) => async(dispatch)=> {
    ...
    await axios
    .post(`http://localhost:4000/api/v1/auth/password/reset/${token}`,
        data, 
        {
        withCredentials: true,
        headers: {
...
// // -------------------- Fake Login ---------------------
// export const fakeLogin = (data) => (dispatch) => {
//   dispatch(authSlice.actions.loginRequest());
...
//       );
//     } else {
//       dispatch(authSlice.actions.loginFailed("Email hoặc mật khẩu không đúng"));
//     }
//   }, 1000);
// };
// // -----------------------------------------------------
...
//   dispatch(authSlice.actions.resetPasswordRequest());
//   try {
//     const res = await axios.post(`http://localhost:4000/api/v1/auth/password/reset/${token}`, data, {
//       withCredentials: true,
//       headers: {
//         "Content-Type": "application/json",
//       },
